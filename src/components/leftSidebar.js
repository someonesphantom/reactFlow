...
const LeftSidebar = () => {
    ...
    let ArrayObjectOfNodes = [{ type: "JSON",id:1 },{ type: "XML",id:2 },{ type: "CSV",id:3 },{ type: "XLSX",id:4 }]
    return (
        <aside>
            ...
            {ArrayObjectOfNodes.map(
                nodeInfo => <div key={nodeInfo.id} onDragStart={(e) => onDragStart(e, 'source', nodeInfo.type)} style={{display:"flex",justifyContent:"center"}} draggable>
                    {
